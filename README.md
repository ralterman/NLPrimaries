...
Data:
- Gathered data through the use of Twint — an advanced Twitter scraping tool
...
Process:
- Performed sentiment and subjectivity analysis, as well as TF-IDF on each tweet
- Created multiple visualizations, as can be seen in NLPrimaries.pdf in this repository
- Wrapped up analysis through topic modeling with the use of latent dirichlet allocation (LDA), in an attempt to see if tweets would be separated by candidate (also can be seen in NLPrimaries.pdf)
